          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="flex items-end">
              <button
                onClick={search}
                disabled={searching}
                className="w-full rounded-full bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-medium py-2.5 disabled:opacity-60"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                maxLength={11}
                className="w-full rounded-2xl border border-gray-200 bg-white px-4 py-2.5 text-sm shadow-[inset_0_1px_2px_rgba(124,92,252,0.06)] disabled:opacity-50"
              />
              ...
              {results.map((n) => (
                <li key={n.phoneNumber} className="flex items-center justify-between px-4 py-3">
                  ...
                  <button
                    ...
                    className="rounded-full bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-medium px-3.5 py-1.5 disabled:opacity-60"
                  >
...
function NumberRow({ number }: { number: PhoneNumberRecord }) {
  return (
    <li className="rounded-2xl border border-gray-200 bg-white p-4 shadow-[0_4px_20px_rgba(124,92,252,0.06)]">
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div>
          <div className="text-sm font-medium">
            {number.friendlyName}
            {number.isMock && (
              <span className="ml-2 text-[10px] uppercase tracking-wide bg-amber-500/15 text-amber-600 rounded-full px-1.5 py-0.5">
                mock
              </span>
            )}
          </div>
