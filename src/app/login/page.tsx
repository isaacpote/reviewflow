...
const GOOGLE_ERRORS: Record<string, string> = {
  ...
  google_failed: "Couldn't sign you in with Google. Try again.",
  ...
  return (
    <main className="flex-1 flex items-center justify-center px-6 py-16">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-black/10 dark:border-white/10 p-6 sm:p-8 space-y-5 bg-white/50 dark:bg-white/[0.03]">
          {googleError && (
            <p className="text-sm text-red-500">
              {GOOGLE_ERRORS[googleError] ?? "Something went wrong signing in with Google."}
            </p>
          )}
